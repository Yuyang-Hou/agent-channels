...
正式 `0.3.0-beta.19` 包已使用 Developer ID 签名并通过 Apple 公证；若 Gatekeeper 仍拦截，
...
[`v0.3.0-beta.19`](https://github.com/Yuyang-Hou/agent-channels/releases/tag/v0.3.0-beta.19)
